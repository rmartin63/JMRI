...
public class LayoutPanelNewFormat extends JPanel {

	private static LayoutPanelNewFormat _instance = null;  //A singleton class!
	...
	protected LayoutPanelNewFormat() {
	...
	public static LayoutPanelNewFormat getInstance() {
		if(_instance == null) {
			_instance = new LayoutPanelNewFormat();
		}
		return _instance;
	}
...
*/
		...
		if(hasPanelSizeChanged == true) {
			...
			System.out.println("\n**************\nLayoutPanelNewFormat PanelSizeChanged!!"+
								"LayoutPanelNewFormat psize="+pSize+" prevPanelSize="+prevPanelSize);
			if(turnTable != null) {
				turnTable.unManage();
			}
...
} //End of LayoutPanelNewFormat Class Definition...