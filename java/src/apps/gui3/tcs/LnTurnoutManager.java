...
public class LnTurnoutManager extends jmri.managers.AbstractTurnoutManager implements LocoNetListener {
    ...
    protected LocoNetInterface fastcontroller;
    protected LocoNetInterface throttledcontroller;
    ...
    protected LocoNetMessage lastSWREQ = null;
    ...
    protected static Logger log = LoggerFactory.getLogger(LnTurnoutManager.class.getName());
}
