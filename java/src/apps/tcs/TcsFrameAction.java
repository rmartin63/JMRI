 ...
 */
public class TcsFrameAction extends JmriAbstractAction {

    public TcsFrameAction(String s, WindowInterface wi) {
        super(s, wi);
    }

    public TcsFrameAction(String s, WindowInterface wi, boolean allowQuit) {
        super(s, wi);
        this.allowQuit=allowQuit;
    }

    public TcsFrameAction(String s, Icon i, WindowInterface wi) {
        super(s, i, wi);
    }
     ...
     */
    public TcsFrameAction() {
        super(ResourceBundle.getBundle("apps.ActionListBundle").getString("apps.gui3.tcs.TcsFrameAction"));
        allowQuit = false;
    }
    /**
    * Method for opening a new window via the classic JMRI interface
    */
    public TcsFrameAction(String pName, boolean allowQuit) {
        super(pName);
        this.allowQuit=allowQuit;
    }
