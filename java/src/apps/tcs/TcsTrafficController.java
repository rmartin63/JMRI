...
/**
 * Class modeled after Test scaffold implementation (LocoNetInterfaceScaffold) of LocoNetInterface.
 * Use an object of this type as a LnTrafficController in tests.
 *
 * @author  Bob Jacobsen Copyright (C) 2001, 2006
 */
public class TcsTrafficController extends LnTrafficController {

    public TcsTrafficController() {
    }

    public TcsTrafficController(LocoNetSystemConnectionMemo adaptermemo) {
        super(adaptermemo);
    }
    ...
    private final static Logger log = LoggerFactory.getLogger(TcsTrafficController.class);
